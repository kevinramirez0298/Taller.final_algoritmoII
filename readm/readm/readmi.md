...
En base a la necesidad del problema se requiere una plataforma de análisis académico para procesa diariamente los resultados de pruebas realizadas por estudiantes de todo el país.
